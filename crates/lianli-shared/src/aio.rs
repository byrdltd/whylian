...
pub struct AioConfig {
    ...
    #[serde(default = "rgba_white")]
    pub unit_color: [u8; 4],
    /// Wireless device_id of an external TLV2 radiator fan cluster when the AIO
    /// record reports `fan_count == 0` (HydroShift II LCD-S/C AdvanceMode).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub radiator_fan_device_id: Option<String>,
}
